...
function createPoster() {
    ...
    $('.poster-img').append('<img id="imgbase64" class="wh-100" style="object-fit:cover;" src="' + posterImg + '">');
    ...
    $('.poster-info').append('<div class="poster-footer-box"><div style="height: 90px;"><div class="poster-author"><div class="poster-avatar-box ycenter"></div><div class="poster-author-info"><div class="ycenter"></div></div></div><div class="pfooter"><span class="xcenter">Quét mã QR để xem</span></div></div><div id="poster-qrcode" class="poster-qrcode ycenter"></div></div>')
    $('.poster-avatar-box').append('<img class="poster-avatar ycenter" src="' + AvaImage + '">')
    $('.poster-author-info div').append('<span>Tác giả: ' + posterAuthor + '</span><span>Thời gian: ' + posterDate + '</span>');
    makeCode();
};
