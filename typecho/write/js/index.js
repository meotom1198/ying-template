				...
				el.on('click', e => {
					...
					switch (item.type) {
						...
						case 'about':
							...
							break;
						case 'character':
							super._createTableLists(this.cm, JoeConfig.characterAPI, 'Biểu tượng ngôi sao', 'Nhân vật');
							break;
						case 'emoji':
							super._createTableLists(this.cm, JoeConfig.emojiAPI, 'Biểu thức', 'Biểu thức ký hiệu (yêu cầu hỗ trợ cơ sở dữ liệu)');
							break;
						case 'task-no':
